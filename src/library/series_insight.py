...
from library.models import Kind, SeriesInsight
...
def build_series_prompt(summary: SeriesSummary) -> str:
...
async def generate_description(
    client: AsyncAnthropic, model: str, summary: SeriesSummary
) -> tuple[str, int, int]:
    ...
    response = await client.messages.create(
        ...
        messages=[{"role": "user", "content": build_series_prompt(summary)}],
    )
    text = "".join(
