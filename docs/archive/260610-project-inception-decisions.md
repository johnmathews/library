# Library — project inception decisions

**Status:** historical. A record of what was decided on 2026-06-10, before any
code existed. It is **not** a description of the system as built and is not
maintained — where it disagrees with [architecture.md](../architecture.md), the
latter is correct. Restored to `docs/archive/` on 2026-08-11 (from commit
`9d48ddc^`) because [architecture.md](../architecture.md) cites the decision
record and the path it pointed at no longer existed.

**Original header:** Date 2026-06-10 — agreed with John; source of truth for the
initial build.
