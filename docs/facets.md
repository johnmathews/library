...
labeller's own casefolded resolution — §3) and reported as "already an
alias" rather than let through to the server's idempotent `200`, which would
otherwise look like a successful addition of something new.
