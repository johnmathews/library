...
**Five measurements, and the criterion is now met in both environments.**
...
either the archive or the corpus differs from the recorded one by more than ten
per cent — the delta then reflects the change of haystack as much as any change
in retrieval.
