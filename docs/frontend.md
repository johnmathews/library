...
- **Nav items** (RouterLink, gradient violet active state): **Documents** (`/`),
  **Upload** (`/upload`), **New note** (`/notes/new`,
  ...
  (`/settings`), **Jobs** (`/jobs`), **Charts** (`/charts`), **Projects**
  (`/projects`, `data-testid="sidebar-projects-link"`), and — **for admins
