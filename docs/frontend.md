...
- **Nav items** (RouterLink, gradient violet active state): **Documents** (`/`),
  **Upload** (`/upload`), **Ask** (`/ask`), **Settings** (`/settings`),
  **Jobs** (`/jobs`), **Charts** (`/charts`). Each has a
