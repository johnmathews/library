...
| [`spending-view.md`](spending-view.md) | Using the spending charts: the board and the workspace, asking a question in plain language and its three outcomes, reading the footer's three blocks, drilling from a bar or a footer count to the documents behind it, how colour is assigned, and what the feature does not do yet. The user-facing companion to `charts.md`. |
